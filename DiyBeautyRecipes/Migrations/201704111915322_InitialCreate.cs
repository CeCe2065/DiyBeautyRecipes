namespace DiyBeautyRecipes.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MixtureID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.RecipeID)
                .ForeignKey("dbo.BodyParts", t => t.BodyPartID, cascadeDelete: true)
                .ForeignKey("dbo.Mixtures", t => t.MixtureID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Recipes", "BodyPartID", "dbo.BodyParts");
            ...
            DropIndex("dbo.Recipes", new[] { "BodyPartID" });
